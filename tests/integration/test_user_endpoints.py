...
class TestUserEndpoints:
    ...
    async def test_update_user_invalid_data(self, client: AsyncClient, test_user: User, auth_headers: dict):
    ...
    async def test_change_password_same_password(self, client: AsyncClient, test_user: User, auth_headers: dict):
