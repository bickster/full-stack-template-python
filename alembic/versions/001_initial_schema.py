...
def upgrade() -> None:
    ...
    op.create_index('idx_login_attempts_email_ip', 'login_attempts', ['email', 'ip_address'], unique=False)
    op.create_index('idx_login_attempts_ip', 'login_attempts', ['ip_address'], unique=False)
    op.create_index('idx_login_attempts_time', 'login_attempts', ['attempted_at'], unique=False)
